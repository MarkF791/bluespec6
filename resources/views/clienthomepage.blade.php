...
<body>
    ...
    <div>        
        <div id='white_div' class="container-fluid" style="background-color:black; padding-top:50px">
            <iframe src="https://player.vimeo.com/video/314478784?autoplay=1&loop=1" width="100%" height="600" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
        </div>
